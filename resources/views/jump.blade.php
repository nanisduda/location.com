...
<head>
    <meta name="viewport" content="width=device-width, initial-scale=0.8, minimum-scale=0.5, maximum-scale=2.0, user-scalable=yes" />
...
<body class="ie8">
    ...
    <div id="js-alert-box" class="alert-box" style="display: block;">
        ...
        <div class="alert-body">
            <div id="js-alert-head" class="alert-head">前往查询中心</div>
            <div class="alert-concent">
                <p>花 3 分钟咨询客服开通</p>
                <p>您将一年无限制查询所有信息</p>
            </div>
            <a id="js-alert-btn" class="alert-btn" href="/center">立即前往查询中心</a>
        </div>
