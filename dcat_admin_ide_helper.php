...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection hot_desc
     * @property Grid\Column|Collection comment_cnt
     ...
     * @method Grid\Column|Collection hot_desc(string $label = null)
     * @method Grid\Column|Collection comment_cnt(string $label = null)
     ...
     * @property Show\Field|Collection hot_desc
     * @property Show\Field|Collection comment_cnt
     ...
     * @method Show\Field|Collection hot_desc(string $label = null)
     * @method Show\Field|Collection comment_cnt(string $label = null)
